      ...
      apiGet('/auth/who').then(function(r) {
        ...
        overlay.innerHTML = '<div class="auth-container">' +
          '<div class="auth-brand">' +
            '<div class="auth-logo-wrap"><img class="auth-logo auth-logo-light" src="assets/align-logo-light-v3.png" alt="Align" /><img class="auth-logo auth-logo-dark" src="assets/align-logo-dark-v3.png" alt="Align" /></div>' +
