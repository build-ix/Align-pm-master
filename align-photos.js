...
function render(c){if(!c)return;st.container=c;st.viewingPhoto=null;st.selectMode=false;st.selected={};st.filterCompany='all';st.sortBy='date-desc';_pid();_paint();}
