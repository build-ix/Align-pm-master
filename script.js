...
function _handleRoute() {
  ...
  var cacheEntry = (sectionKey === 'settings' || sectionKey === 'essentials-config' || sectionKey === 'daily-logs' || sectionKey === 'contacts' || sectionKey === 'project-select') ? null : _tileCache[sectionKey];
